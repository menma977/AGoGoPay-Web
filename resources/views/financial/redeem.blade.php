...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Keseluruhan <small>Keuangan</small></h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Halaman Utama</a></li>
                <li class="breadcrumb-item">Keseluruhan Keuangan</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Keseluruhan Keuangan</h3>
            </div>
            <div class="card-body">
                <table style="margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <h3 class="card-title">{{ $ledger->sum('kredit') - $ledger->sum('debet') }}</h3>
                        </td>
                    </tr>
                </table>
